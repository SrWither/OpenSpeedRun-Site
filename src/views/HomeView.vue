      ...
      <div class="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
        <div class="mx-auto max-w-2xl text-center">
          ...
          <p class="mt-5 text-lg text-ink-muted">
            ...
            BSD — a clean GUI, external CLI control, GLSL shader backgrounds, and no dependencies
            on non-Unix libraries.
          </p>
          ...
          <div class="mx-auto mt-3 w-fit font-mono text-6xl font-bold tabular-nums text-accent/90 sm:text-7xl">
            00:00.000
          </div>
        </div>

        <div class="mx-auto mt-14 grid max-w-4xl grid-cols-2 gap-4 sm:gap-6">
          <figure class="overflow-hidden rounded-xl border border-border shadow-2xl shadow-black/10">
            <img src="/screenshots/timer.png" alt="OpenSpeedRun timer, default theme" class="w-full" />
            <figcaption class="border-t border-border bg-surface-alt px-3 py-1.5 text-xs text-ink-muted">
              Default theme
            </figcaption>
          </figure>
          <figure class="overflow-hidden rounded-xl border border-border shadow-2xl shadow-black/10">
            <img src="/screenshots/timer2.png" alt="OpenSpeedRun timer with a shader background" class="w-full" />
            <figcaption class="border-t border-border bg-surface-alt px-3 py-1.5 text-xs text-ink-muted">
    ...
    <section class="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      ...
      <div class="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <FeatureCard icon="🖼️" title="Themes & shaders">
          Colors, fonts, spacing, and animated GLSL shader backgrounds — configure everything from
          a dedicated editor, no JSON hand-editing required.
        </FeatureCard>
        <FeatureCard icon="🖥️" title="External CLI control">
          ...
          resets, and pauses to system-wide shortcuts — built for Wayland compositors with no
        ...
        <FeatureCard icon="🧩" title="Full split editor">
          ...
          Time vs Real Time — and LiveSplit <code class="font-mono text-xs">.lss</code> import/export,
          icons included.
        </FeatureCard>
        ...
        <FeatureCard icon="📊" title="CSV export">
          Export your full attempt and segment history to CSV and build your own stats in
          whatever tool you like — Excel, pandas, Grafana, your call.
        </FeatureCard>
      </div>
    </section>
    ...
    <section class="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      ...
      <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div class="rounded-lg border border-border p-4">
          ...
          <p class="mt-1 text-sm text-ink-muted">Configuration GUI for splits, themes and shaders.</p>
        </div>
        <div class="rounded-lg border border-border p-4">
        ...
        <div class="rounded-lg border border-border p-4">
          ...
          <p class="mt-1 text-sm text-ink-muted">Headless autosplitter, RetroArch or native process memory.</p>
        </div>
      </div>
    </section>
